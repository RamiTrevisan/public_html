  ...
  return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.Deferred(function (deferred) {
    ...
    $img.one('load', function () {
      ...
      deferred.reject($img);
        ...
        display: 'none'
    }).addClass("img-fluid").appendTo(document.body).attr('src', url);
  }).promise();
}
...
var Buttons_Buttons = /*#__PURE__*/function () {
  ...
  Buttons_createClass(Buttons, [{
    ...
    value: function addImagePopoverButtons() {
      ...
      this.context.memo('button.resizeTenth', function () {
        return _this3.button({
          contents: '<span class="note-fontsize-10">10%</span>',
          tooltip: _this3.lang.image.resizeTenth,
          click: _this3.context.createInvokeHandler('editor.resize', '0.10')
        }).render();
      });
...
external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote, {
  ...
  options: {
    ...
    popatmouse: true,
    popover: {
      image: [['resize', ['resizeFull', 'resizeHalf', 'resizeQuarter', 'resizeTenth', 'resizeNone']], ['float', ['floatLeft', 'floatRight', 'floatNone']], ['remove', ['removeMedia']]],
...
var dialog = renderer["a" /* default */].create('<div class="note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', function ($node, options) {
  ...
  $node.html(['<div class="note-modal-content">', options.title ? '<div class="note-modal-header"><button type="button" class="close" aria-label="Close" aria-hidden="true"><i class="note-icon-close"></i></button><h4 class="note-modal-title">' + options.title + '</h4></div>' : '', '<div class="note-modal-body">' + options.body + '</div>', options.footer ? '<div class="note-modal-footer m-3">' + options.footer + '</div>' : '', '</div>'].join(''));
